...
@dataclass
class SelectiveCausalLMOutputWithPast(CausalLMOutputWithPast):
    selected_layer_indices: Optional[List[List[int]]] = None
...
class SelectiveSimpleForCausalLM(Phi3ForCausalLM):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
    ) -> Union[Tuple, SelectiveCausalLMOutputWithPast]:
        output_attentions = (
            output_attentions
            if output_attentions is not None
            else self.config.output_attentions
        ...
        return SelectiveCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
            past_key_values=outputs.past_key_values,
            hidden_states=outputs.hidden_states,
            attentions=outputs.attentions,
            selected_layer_indices=outputs.selected_layer_indices,
        )
